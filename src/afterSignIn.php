...
<body>
   ...
   <div class="container" style="position: relative; margin-top: 130px; margin-left: 0px; width: 900px;">
     ...
     <div class="col-3 ml-5 p-3" style="position: absolute; left: 900px; top: 130px; border: 1px solid black;">
        <div class="py-4 h4 text-center" style="color:green"><b>Your Order</b></div>
        <form action="payment.php" method="post">
          Item Name : <input id="itmName" type="text" name="itemName" class="float-right px-2" readonly required><br><br>
          Amount : <input id="itmCost" type="text" name="cost" class="float-right px-2" readonly required><br><br><br>
		  <p style="color:red">Proceed Securly* <input type='hidden' name='strcrypt' id='strcrypt' size='55' required />
<!--          <input id="hash" type="text" name="hash" style="display: none;">-->
		<!-- input name="Clear" type="reset" value="clear" class="float-left btn btn-primary" -->
		<input type='button' id='cryptstr' value='Confirm' /></p><br>
...
//code of SHA512 function
		...
		var txt_string = document.getElementById('itmCost').value; // gets data from input text
